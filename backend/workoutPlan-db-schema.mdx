...
# DB Schema : Workout Plan

This document lists the key schemas and important fields used by the Workout Plan module. These are inferred from controller usage and should be confirmed against the canonical schema definitions in `index.d.ts` or the shared-models package.
---
