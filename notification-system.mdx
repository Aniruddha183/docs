...
</Step> <Step title="Integrate Notification Request in App"> Add notification permissions and initialize listeners in your Next.js application:

```tsx file="NotificationComponent.tsx"
"use client";
